...
static void TryLoadDefaultTrueTypeFont([[maybe_unused]] FontSize fs, uint size);
...
static void LoadFontHelper(FontSize fs, const std::string &file_name, uint size)
{
#ifdef WITH_FREETYPE
...
static void TryLoadDefaultTrueTypeFont([[maybe_unused]] FontSize fs, uint size = 0)
{
